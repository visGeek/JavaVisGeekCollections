...
public interface Action2<T1, T2> {
	 ...
	 * @return
	 */
	default Action1<T2> partialApply(T1 arg1) {
	 ...
	 * @return
	 */
	public static <T1, T2> Action2<T1, T2> create(WithException<T1, T2> actionWithException) {
		return (arg1, arg2) -> {
			try {
	...
	@FunctionalInterface
	public static interface WithException<T1, T2> {
