...
public interface Func7<T1, T2, T3, T4, T5, T6, T7, TResult> {
	 ...
	 * @return
	 */
	default Func6<T2, T3, T4, T5, T6, T7, TResult> toFunc6(T1 arg1) {
	 ...
	 * @return
	 */
	public static <T1, T2, T3, T4, T5, T6, T7, TResult> Func7<T1, T2, T3, T4, T5, T6, T7, TResult> create(Func7WithException<T1, T2, T3, T4, T5, T6, T7, TResult> funcWithException) {
