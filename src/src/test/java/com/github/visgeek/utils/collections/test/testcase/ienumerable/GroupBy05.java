...
public class GroupBy05 {
	...
	public void arg1IsNull() {
		...
		Action0 action = () -> Enumerable.empty(Entry.class).groupBy(keySelector, resultSelector);
	...
	public void test01() {
		...
		IEnumerable<Group> groups =
				Enumerable
						.of(source)
						.groupBy(ety -> ety.key, resultSelector);
	...
	private static class Group {
		...
		final IEnumerable<Entry> entries;
	}
}
