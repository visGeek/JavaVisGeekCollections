...
public class GroupJoin04 {
	...
	public void arg1IsNull() {
		...
		Action0 action = () -> keys.groupJoin(values, outerKeySelector, innerKeySelector, resultSelector, comparator);
	...
	public void test01() {
		...
		IReadOnlyList<ResultItems> actual =
				keys
						.groupJoin(values, key -> key, value -> value.key, resultSelector, comparator)
						.toList();
