...
public class Join02 {
	...
	public void arg1IsNull() {
		...
		Action0 action = () -> keys.join(values, outerKeySelector, innerKeySelector, resultSelector);
	...
	public void test01() {
		...
		Func2<String, Item, ResultItem> resultSelector = (key, item) -> new ResultItem(key, item);

		IReadOnlyList<ResultItem> actual =
				keys
						.join(values, key -> key, value -> value.key, resultSelector)
						.toList();
