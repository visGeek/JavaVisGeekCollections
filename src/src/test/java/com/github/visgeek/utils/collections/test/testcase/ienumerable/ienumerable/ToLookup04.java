...
public class ToLookup04 {
	...
	public void arg1IsNull() {
		...
		Action0 action = () -> Enumerable.empty(Entry.class).toLookup(keySelector, elementSelector, comparator);
	...
	public void test01() {
		...
		ILookup<String, Integer> lookup =
				Enumerable
						.of(source)
						.toLookup(ety -> ety.key, elementSelector, comparator);
