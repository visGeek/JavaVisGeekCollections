...
public class Aggregate {
	...
	public void test01_01() {
		Assert2.assertNullPointerExceptionThrown("func", () -> Enumerable.of(1, 2, 3).aggregate(null));
	}
	...
	public void test01_03() {
		Assert2.assertExceptionThrown(UnsupportedOperationException.class, () -> Enumerable.empty(Integer.class).aggregate((n1, n2) -> n1 + n2));
	}
