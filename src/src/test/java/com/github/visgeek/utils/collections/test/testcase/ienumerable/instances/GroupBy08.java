...
public class GroupBy08 {
	...
	public void arg1IsNull() {
		...
		Action0 action = () -> Enumerable.empty(Entry.class).groupBy(keySelector, elementSelector, resultSelector, comparator);
	...
	public void test01() {
		...
		IEnumerable<Group> groups =
				Enumerable
						.of(source)
						.groupBy(ety -> ety.key, elementSelector, resultSelector, comparator);
