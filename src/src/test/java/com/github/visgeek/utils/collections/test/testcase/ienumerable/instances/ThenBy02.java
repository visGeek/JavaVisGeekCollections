...
public class ThenBy02 {
	...
	public void arg1IsNull() {
		...
		Action0 action = () -> source.orderBy((a, b) -> 0).thenBy(keySelector, comparator);
	...
	public void test() {
		...
		IEnumerable<Tuple3<Integer, String, String>> ordered =
				source
						.orderBy(val -> val.item3(), this.comparator)
						.thenBy(val -> val.item2(), this.comparator);
